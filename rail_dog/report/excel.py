"""
ExcelMixin: all Excel workbook writing methods for Report.
"""
import logging
import os
...
from rail_dog.report.treatment import PLAINLINE_TREATMENT_HIERARCHY
...
class ExcelMixin:
    ...
    def write_excel_report(self):
        ...
        logging.info(f"Excel report saved to: {output_file}")
